	...
	public boolean onNavigationItemSelected(@NonNull MenuItem item) {
		...
		switch(id)
		{
			...
			/*case R.id.miAvaliarPlaystore:
				String url = "https://play.google.com/store/apps/details?id=com.juniocam.blendvpn";
			...
			case R.id.miSendFeedback:
				if (false && Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
					...
					email.putExtra(Intent.EXTRA_SUBJECT, "Blend - " + mActivity.getString(R.string.feedback));  
