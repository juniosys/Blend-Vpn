...
public class LogItem implements Parcelable {
    ...
    BlendStatus.LogLevel mLevel = BlendStatus.LogLevel.INFO;
	...
	public LogItem(BlendStatus.LogLevel loglevel, int verblevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
		mVerbosityLevel = verblevel;
    }

    public LogItem(BlendStatus.LogLevel level, int resId, Object... args) {
        mLevel = level;
		mResourceId = resId;
		mArgs = args;
    }
	
	public LogItem(BlendStatus.LogLevel loglevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
    }


    public LogItem(BlendStatus.LogLevel loglevel, int ressourceId) {
    ...
    public LogItem(Parcel in) {
        ...
        mLevel = BlendStatus.LogLevel.getEnumByValue(in.readInt());
        logtime = in.readLong();
    }
    ...
    public BlendStatus.LogLevel getLogLevel() {
        return mLevel;
    }
    ...
    private String getAppInfoString(Context c) {
        ...
        try {
            ...
            if (!Arrays.equals(digest, BlendStatus.oficialkey) && !Arrays.equals(digest, BlendStatus.oficialdebugkey))
