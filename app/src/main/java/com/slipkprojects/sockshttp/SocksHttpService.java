...
import com.slipkprojects.sockshttp.aidl.ISocksHttpInternal;
...
import com.slipkprojects.sockshttp.tunnel.TunnelManagerThread;
...
import com.slipkprojects.sockshttp.util.DummyActivity;
...
implements SkStatus.StateListener
{
	...
	private final IBinder mBinder = new ISocksHttpInternal.Stub() {
