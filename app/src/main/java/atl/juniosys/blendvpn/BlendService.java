...
import atl.juniosys.blendvpn.BlendService;
import atl.juniosys.blendvpn.R;
import atl.juniosys.blendvpn.aidl.IBlendInternal;
import atl.juniosys.blendvpn.config.Settings;
import atl.juniosys.blendvpn.logger.BlendStatus;
import atl.juniosys.blendvpn.logger.ConnectionStatus;
import atl.juniosys.blendvpn.tunnel.TunnelManagerThread;
import atl.juniosys.blendvpn.tunnel.TunnelUtils;
import atl.juniosys.blendvpn.util.DummyActivity;
import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

public class BlendService extends Service
implements BlendStatus.StateListener
{
	private static final String TAG = BlendService.class.getSimpleName();
	public static final String START_SERVICE = "atl.juniosys.blendvpn:startTunnel";
	...
	private final IBinder mBinder = new IBlendInternal.Stub() {

        @Override
        public void stopVPN() {
            BlendService.this.stopTunnel();
        }
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		String stateMsg = getString(BlendStatus.getLocalizedState(BlendStatus.getLastState()));
	...
	public synchronized void startTunnel() {
		...
		BlendStatus.updateStateString(BlendStatus.SSH_INICIANDO, getString(R.string.starting_service_ssh));

		networkStateChange(this, true);

		BlendStatus.logInfo(String.format("Ip Local: %s", getIpPublic()));
		...
		try {
			...
			BlendStatus.logInfo("started Tunnel Thread");

		} catch(Exception e) {
			BlendStatus.logException(e);
			endTunnelService();
		}
	}
	...
	public synchronized void stopTunnel() {
		if (mTunnelManager != null) {
			...
			if (mTunnelThread != null) {
				...
				BlendStatus.logInfo("stopped Tunnel Thread");
			}
    ...
    public void onLowMemory() {
        ...
        BlendStatus.logWarning("Low Memory Warning!");
    }
	...
	public void endTunnelService() {
		mHandler.post(new Runnable() {
				...
				public void run() {
					...
					stopSelf();
					BlendStatus.removeStateListener(BlendService.this);
				}
			});
	}
	...
	public static PendingIntent getGraphPendingIntent(Context context) {
        ...
        intent.setComponent(new ComponentName(context, context.getPackageName() + ".BlendMainActivity"));
	...
	private ConnectivityManager.NetworkCallback networkCallback = new ConnectivityManager.NetworkCallback() {
		...
		public void onAvailable(Network net) {
			BlendStatus.logDebug("Rede disponivel");
		}

		@Override
		public void onLost(Network net) {
			BlendStatus.logDebug("Rede perdida");
		}

		@Override
		public void onUnavailable() {
			BlendStatus.logDebug("Rede indisponivel");
		}
	};

	public static final String TUNNEL_SSH_RESTART_SERVICE = BlendService.class.getName() + "::restartservicebroadcast",
	TUNNEL_SSH_STOP_SERVICE = BlendService.class.getName() + "::stopservicebroadcast";
	...
	protected void networkStateChange(Context context, boolean showStatusRepetido) {
		...
		if (showStatusRepetido || !netstatestring.equals(lastStateMsg))
			BlendStatus.logInfo(netstatestring);
