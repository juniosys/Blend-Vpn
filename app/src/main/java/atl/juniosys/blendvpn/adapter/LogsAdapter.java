package atl.juniosys.blendvpn.adapter;
...
import atl.juniosys.blendvpn.logger.LogItem;
...
public class LogsAdapter extends RecyclerView.Adapter<LogsAdapter.logViewHolder>
	implements BlendStatus.LogListener, Handler.Callback,
		View.OnTouchListener
{
	...
	{ 
		...
		if (new Settings(mContext).getModoDebug()) {
			setLogLevel(BlendStatus.LogLevel.DEBUG.getInt());
		}
		...
		BlendStatus.addLogListener(this);
	} 
	...
	{
		allEntries.clear();
		Collections.addAll(allEntries, BlendStatus.getlogbuffer());
		initCurrentMessages();
	}
