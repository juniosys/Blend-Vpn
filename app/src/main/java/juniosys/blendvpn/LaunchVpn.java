...
import juniosys.blendvpn.config.PasswordCache;
...
{
	public static final String EXTRA_HIDELOG = "juniosys.blendvpn.showNoLogWindow";
	...
	private void showLogWindow() {
        Intent updateView = new Intent("juniosys.blendvpn:openLogs");
